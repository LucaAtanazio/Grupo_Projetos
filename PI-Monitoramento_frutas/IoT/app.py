...
def exportar_tipo(tipo):
    # Rota usada para exportar: http://192.168.0.62:8080/exportar/banana
    # Também pode ser usada para http://192.168.0.62:8080/exportar/tomate
    if tipo == "todas":
...
if __name__ == "__main__":
    ...
    # outros dispositivos na rede local (como o ESP32 no 192.168.0.62).
    print("Servidor rodando na sua rede local (verifique seu IP): Porta 8080")
    socketio.run(app, host="192.168.0.5", port=8080)