...
// =========================================
String tipoFruta = "banana";
String lote = "lote_M"; // Mudar a cada monitoramento
String estado_real = "madura"; // Mudar a cada monitoramento = [sem risco|madura|alerta|risco de perda]
