...
* [@eopabro](https://github.com/eopabro) - Pablo Henrique: **Desenvolvimento e Implementação do Código Embarcado**, **Elaboração Conceitual do Projeto**, e **Pesquisa de Campo**.
* [@LucaAtanazio](https://github.com/LucaAtanazio) - Luca Atanazio: **Tratamento de dados**, **Arquitetura e Apresentação do Projeto**, **Gerenciamento de Recursos e Aquisição de Hardware**, **Elaboração Conceitual do Projeto**, e **Pesquisa de Campo**.
---
